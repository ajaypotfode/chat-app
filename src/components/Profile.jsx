...
const Profile = ({ handlechatForm }) => {
    ...
    return (
        ...
        >
            ...
            {
                profileData && <div className="bg-[#2A2A2A] p-8 rounded-2xl w-full max-w-md shadow-lg flex flex-col justify-center items-center" onClick={(e) => e.stopPropagation()}>
                    {/* form */}
